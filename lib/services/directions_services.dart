...
class ServiceDirections {
  //TODO:Actions fors directions by user
  ...
  static deleteDirection(int idDirection) async {
    bool _result = false;
    var _url = Uri.parse("http://awsms.syncronik.com/api/locations/delete/" +
  ...
  static updateDirection(LocationData data) async {
    bool _result = false;
    int _id = await ServiceStorage.getIdUser();
    var _url = Uri.parse("http://awsms.syncronik.com/api/locations/update/" +
        _id.toString() +
        "/");
    Map<String, String> requestHeaders = {
      'Content-type': 'application/json',
